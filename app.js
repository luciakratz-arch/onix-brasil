...
const COR       = "#5B2D8E";
const COR_FUNDO = "#F3EEF9";
const LOGO_URL  = "https://raw.githubusercontent.com/luciakratz-arch/onix-brasil/main/onix-logo.png";
...
function CadastroPublico({ config }) {
    ...
    return (
        <div style={{ minHeight:"100vh", background:fundo, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"32px 20px" }}>
            ...
            <div style={{ marginTop:24, fontSize:11, color:"#CCC" }}>{config.nomeApp||"Onix Brasil Vocal Internacional"} · Portal de Gestão</div>
        </div>
    );
}
    ...
    return (
        <div style={{ minHeight:"100vh", background:"#111", color:"#fff", fontFamily:"'Inter',sans-serif" }}>
            ...
            <div style={{ background:"#1A1D23", padding:"16px 24px", borderBottom:"1px solid #333", display:"flex", alignItems:"center", gap:12 }}>
                ...
                <div>
                    <div style={{ fontFamily:"'Playfair Display',serif", fontSize:16, fontWeight:700, color:"#fff" }}>{config.nomeApp||"Onix Brasil Vocal Internacional"}</div>
...
function Login({ members, onLogin, config }) {
    ...
    const s = {
        ...
        btnSec: { flex:1, padding:"13px", background:"#F3EEF9", color:cor, border:"none", borderRadius:10, fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit" },
    ...
    return (
        <div style={s.wrap}>
            ...
            {!tela && <div style={s.card}>
                {[
                    { id:"admin",   icon:"shield",     label:"Acesso Administrativo", sub:"Gestão completa do coral",   cor:COR,       bg:"rgba(91,45,142,0.08)" },
            ...
            <div style={{ marginTop:32, fontSize:11, color:"#CCC" }}>{config.nomeApp||"Onix Brasil Vocal Internacional"} · Portal de Gestão</div>
        </div>
    );
}
    ...
    return (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }}
            ...
            <div style={{ background:"#FAFAFA", borderRadius:"20px 20px 0 0", padding:"24px 20px", width:"100%", maxWidth:640, maxHeight:"92vh", overflowY:"auto" }}>
                ...
                <div style={{ display:"flex", gap:10 }}>
                    {membro && <button onClick={excluir} style={{ padding:"12px 16px", background:"#FFF0F0", color:"#5B2D8E", border:"1px solid #F5DADA", borderRadius:10, fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Excluir</button>}
    ...
    return (
        <div>
            ...
            <div style={{ background:"#fff", borderRadius:12, border:"1px solid #EEE8E8", overflow:"hidden", boxShadow:"0 1px 4px rgba(0,0,0,0.04)" }}>
                <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 90px 90px 80px", padding:"10px 16px", borderBottom:"1px solid #F3EEF9", background:"#FAFAFA" }}>
...
const STATUS_COLORS  = { Planejada:"#1565C0", Confirmado:"#2E7D32", Cancelado:"#5B2D8E", Reagendado:"#E65100", Suspenso:"#7B1FA2" };
    ...
    return (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }}
            ...
            <div style={{ background:"#FAFAFA", borderRadius:"20px 20px 0 0", padding:"24px 20px", width:"100%", maxWidth:640, maxHeight:"92vh", overflowY:"auto" }}>
                ...
                <div style={{ display:"flex", gap:10 }}>
                    {evento && <button onClick={excluir} style={{ padding:"12px 16px", background:"#FFF0F0", color:"#5B2D8E", border:"1px solid #F5DADA", borderRadius:10, fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Excluir</button>}
                    <button onClick={onClose} style={{ flex:1, padding:"13px", background:"#F0EAE8", color:"#666", border:"none", borderRadius:10, fontSize:14, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Cancelar</button>
                    <button onClick={salvar} disabled={salvando} style={{ flex:1, padding:"13px", background:cor, color:"#fff", border:"none", borderRadius:10, fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit", opacity:salvando?0.7:1 }}>
    ...
    return (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:400, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}
            ...
            <div style={{ background:"#fff", borderRadius:16, padding:"24px 20px", width:"100%", maxWidth:360, boxShadow:"0 8px 32px rgba(0,0,0,0.15)" }}>
                ...
                <button onClick={excluirSoEste} disabled={excluindo} style={{ ...btnBase, background:"#F3EEF9", color:"#5B2D8E" }}>Só este evento</button>
                <button onClick={excluirFuturos} disabled={excluindo} style={{ ...btnBase, background:"#FFF3E0", color:"#E65100" }}>Este e os futuros</button>
                <button onClick={excluirTodos} disabled={excluindo} style={{ ...btnBase, background:"#5B2D8E", color:"#fff" }}>Excluir toda a série</button>
    ...
    return (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }}
            ...
            <div style={{ background:"#FAFAFA", borderRadius:"20px 20px 0 0", padding:"24px 20px", width:"100%", maxWidth:640, maxHeight:"93vh", overflowY:"auto" }}>
                ...
                <div style={{ display:"flex", gap:10 }}>
                    {musica && <button onClick={excluir} style={{ padding:"12px 16px", background:"#FFF0F0", color:"#5B2D8E", border:"1px solid #F5DADA", borderRadius:10, fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Excluir</button>}
                    <button onClick={onClose} style={{ flex:1, padding:"13px", background:"#F0EAE8", color:"#666", border:"none", borderRadius:10, fontSize:14, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Cancelar</button>
                    <button onClick={salvar} disabled={salvando} style={{ flex:1, padding:"13px", background:cor, color:"#fff", border:"none", borderRadius:10, fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit", opacity:salvando?0.7:1 }}>
    ...
    function MaterialBadge({ label, icon, url }) {
        ...
        return (
            <button onClick={e=>{e.stopPropagation();setPlayer({url,title:label});}}
                style={{ display:"inline-flex", alignItems:"center", gap:4, padding:"3px 8px", borderRadius:10, background:"#F3EEF9", color:cor, fontSize:11, fontWeight:600, border:"none", cursor:"pointer", fontFamily:"inherit", marginRight:4, marginBottom:4 }}>
...
const TIPOS_MIDIA = [
    ...
    { key:"pdf",    label:"PDF",    icon:"file-text",   bg:"#FFF5F5", color:"#5B2D8E" },
    ...
    return (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }}
            ...
            <div style={{ background:"#FAFAFA", borderRadius:"20px 20px 0 0", padding:"24px 20px", width:"100%", maxWidth:600, maxHeight:"92vh", overflowY:"auto" }}>
                ...
                <div style={{ display:"flex", gap:10 }}>
                    {estudo && <button onClick={excluir} style={{ padding:"12px 16px", background:"#FFF0F0", color:"#5B2D8E", border:"1px solid #F5DADA", borderRadius:10, fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Excluir</button>}
                    <button onClick={onClose} style={{ flex:1, padding:"13px", background:"#F0EAE8", color:"#666", border:"none", borderRadius:10, fontSize:14, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Cancelar</button>
                    <button onClick={salvar} disabled={salvando} style={{ flex:1, padding:"13px", background:cor, color:"#fff", border:"none", borderRadius:10, fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit", opacity:salvando?0.7:1 }}>
                ...
                : <>
                    ...
                    <div style={{ marginBottom:16 }}>
                        {lista.slice(0,10).map(([nome, dados])=>(
                            <div key={nome} style={{ display:"flex", alignItems:"center", gap:10, marginBottom:8 }}>
                                ...
                                <div style={{ flex:1, display:"flex", flexDirection:"column", gap:3 }}>
                                    ...
                                    <div style={{ height:8, background:"#F0F0F0", borderRadius:4, overflow:"hidden" }}>
                                        <div style={{ width:`${(dados.ultimos30/maxTotal)*100}%`, height:"100%", background:"#5B2D8E", borderRadius:4 }} />
                                    </div>
                                </div>
                            </div>
                        ))}
                        <div style={{ display:"flex", gap:16, marginTop:8, justifyContent:"center" }}>
                            ...
                            <div style={{ display:"flex", alignItems:"center", gap:5, fontSize:11, color:"#555" }}><div style={{ width:12, height:12, background:"#5B2D8E", borderRadius:2 }} /> Últimos 30 dias</div>
                        </div>
                    </div>
                    ...
                    <div style={{ border:"1px solid #EEE", borderRadius:8, overflow:"hidden" }}>
                        ...
                        {lista.map(([nome, dados], i)=>(
                            <div key={nome} style={{ display:"grid", gridTemplateColumns:"40px 1fr 80px 80px 1fr", padding:"10px 12px", borderBottom: i<lista.length-1?"1px solid #F5F5F5":"none", alignItems:"center" }}>
                                ...
                                <div><span style={{ display:"inline-block", padding:"2px 8px", borderRadius:20, background:"#FEE2E2", color:"#5B2D8E", fontSize:12, fontWeight:700 }}>{dados.ultimos30}</span></div>
...
function Relatorios({ config }) {
    ...
    const statusColors = { Confirmado:"#2E7D32", Planejada:"#1565C0", Cancelado:"#5B2D8E", Reagendado:"#E65100", Suspenso:"#7B1FA2" };

    const sigLucia  = textos.sigLucia  || "https://raw.githubusercontent.com/luciakratz-arch/onix-brasil/main/lucia-sig.png";
    const sigMaestro= textos.sigMaestro|| "https://raw.githubusercontent.com/luciakratz-arch/onix-brasil/main/paulo-sig.png";

    function gerarPDFListaPresenca() {
        const nomeApp    = config.nomeApp    || "Onix Brasil Vocal Internacional";
...
function CheckinPublico({ sessaoId, config }) {
    ...
    if (status==="ok") return <div style={wrap}>
        <div style={{ textAlign:"center", background:"#fff", borderRadius:20, padding:"32px 24px", maxWidth:360, width:"100%", boxShadow:"0 4px 24px rgba(0,0,0,0.08)" }}>
            ...
            <div style={{ fontSize:12, color:"#CCC" }}>{config.nomeApp||"Onix Brasil Vocal Internacional"}</div>
        </div>
    </div>;
                ...
                <div style={{ display:"flex", gap:12, flexWrap:"wrap", alignItems:"flex-end", marginBottom:16 }}>
                    ...
                    {sessaoAtiva && (
                        <button onClick={encerrarSessao}
                            style={{ padding:"11px 16px", background:"#FFF0F0", color:"#5B2D8E", border:"1px solid #F5DADA", borderRadius:10, fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>
                            Encerrar sessão
                        </button>
                    )}
                </div>
    ...
    return (
        <div>
            ...
            <div style={{ ...card, padding:0, overflow:"hidden" }}>
                {/* Navegação mês */}
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"14px 20px", borderBottom:"1px solid #F3EEF9" }}>
    ...
    return (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }}
            ...
            <div style={{ background:"#FAFAFA", borderRadius:"20px 20px 0 0", padding:"24px 20px", width:"100%", maxWidth:640, maxHeight:"92vh", overflowY:"auto" }}>
                ...
                <div style={{ display:"flex", gap:10 }}>
                    {noticia && <button onClick={excluir} style={{ padding:"12px 16px", background:"#FFF0F0", color:"#5B2D8E", border:"1px solid #F5DADA", borderRadius:10, fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Excluir</button>}
                    <button onClick={onClose} style={{ flex:1, padding:"13px", background:"#F0EAE8", color:"#666", border:"none", borderRadius:10, fontSize:14, fontWeight:600, cursor:"pointer", fontFamily:"inherit" }}>Cancelar</button>
                    <button onClick={salvar} disabled={salvando} style={{ flex:1, padding:"13px", background:cor, color:"#fff", border:"none", borderRadius:10, fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"inherit", opacity:salvando?0.7:1 }}>
...
function AreaRH({ config, abaInicial }) {
    ...
    function gerarDeclCorista() {
        if (!coristaAtual||freqCorista.length===0) return;
        const nomeApp=config.nomeApp||"Onix Brasil Vocal Internacional", logoUrl=config.logoUrl||LOGO_URL;
        const maestro=textos.maestro||"Maestro", produtora=textos.produtora||"Lucia Kratz", cidade=textos.cidade||"Goiânia – GO";
        const sigL=textos.sigLucia||"https://raw.githubusercontent.com/luciakratz-arch/onix-brasil/main/lucia-sig.png";
        const sigM=textos.sigMaestro||"https://raw.githubusercontent.com/luciakratz-arch/onix-brasil/main/paulo-sig.png";
        const hoje=new Date().toLocaleDateString("pt-BR",{day:"numeric",month:"long",year:"numeric"});
            ...
            {aba==="dashboard" && <>
                    ...
                    {Object.entries(naipes).map(([naipe,qtd])=>{
                        ...
                        return (
                            <div key={naipe} style={{ marginBottom:10 }}>
                                ...
                                <div style={{ height:8, background:"#F3EEF9", borderRadius:4, overflow:"hidden" }}>
                ...
                {freqLista.length>0 && <div style={card}>
                    ...
                    {freqLista.map(([nome,qtd])=>(
                        <div key={nome} style={{ marginBottom:10 }}>
                            ...
                            <div style={{ height:6, background:"#F3EEF9", borderRadius:3, overflow:"hidden" }}>
                ...
                {proxEventos.length>0 && <div style={card}>
                    ...
                    {proxEventos.map(e=>{
                        ...
                        return (
                            <div key={e.id} style={{ display:"flex", alignItems:"center", gap:12, padding:"10px 0", borderBottom:"1px solid #F3EEF9" }}>
                                <div style={{ flex:1 }}>
                                    <div style={{ fontSize:13, fontWeight:600, color:"#1A1D23" }}>{e.title}</div>
...
function ModalPagamento({ membro, mesalidade, config, onClose }) {
    const cor = config.corPrimaria||COR;
        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center" }} onClick={e=>e.target===e.currentTarget&&onClose()}>
            <div style={{ background:"#FAFAFA", borderRadius:"20px 20px 0 0", padding:"24px 20px", width:"100%", maxWidth:520, maxHeight:"92vh", overflowY:"auto" }}>
                ...
                <div style={{ marginBottom:14 }}>
                    ...
                    <input style={inp} value={form.descricao} onChange={e=>{setForm(f=>({...f,descricao:e.target.value}));setErro("");}} autoFocus />
                    {erro && <div style={{ fontSize:12, color:cor, marginTop:4 }}>{erro}</div>}
                </div>
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:14 }}>
                    <div>
...
// ── APP ───────────────────────────────────────────────────────────────────────
function App() {
    const [user, setUser]       = useState(()=>{ try{return JSON.parse(localStorage.getItem("onix_user"));}catch{return null;} });
    const [members, setMembers] = useState([]);
    ...
    function handleLogout()  { localStorage.removeItem("onix_user"); setUser(null); }
    ...
    return (
        <div style={{ display:"flex", minHeight:"100vh", background:fundo }}>
            <aside style={{ width:260, background:"#fff", borderRight:"1px solid #EEE0E0", display:"flex", flexDirection:"column", position:"fixed", top:0, left:0, height:"100vh", zIndex:200, boxShadow:"2px 0 12px rgba(0,0,0,0.04)" }} className="sidebar-desktop">
                ...
                <div style={{ padding:"12px 16px", borderTop:"1px solid #F3EEF9" }}>
