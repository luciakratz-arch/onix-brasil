...
function Configuracoes(_ref1) {
  var config = _ref1.config,
    save = _ref1.save;
  var _useState45 = useState(_objectSpread({}, config)),
    _useState46 = _slicedToArray(_useState45, 2),
    form = _useState46[0],
    setForm = _useState46[1];
  var _useState47 = useState(false),
    _useState48 = _slicedToArray(_useState47, 2),
    salvando = _useState48[0],
    setSalvando = _useState48[1];
...
function ModalEvento(_ref10) {
  ...
  var _useState51 = useState(evento ? _objectSpread(_objectSpread(_objectSpread({}, vazio), evento), {}, {
  ...
  var _useState53 = useState(false),
    ...
    salvando = _useState54[0],
    setSalvando = _useState54[1];
  var _useState55 = useState(""),
    _useState56 = _slicedToArray(_useState55, 2),
    erro = _useState56[0],
    setErro = _useState56[1];
  function salvar() {
...
function ModalExcluirEvento(_ref11) {
  ...
  var _useState57 = useState(false),
    ...
    excluindo = _useState58[0],
    setExcluindo = _useState58[1];
...
function Agenda(_ref12) {
  ...
  var _useState59 = useState(new Date().getMonth()),
    ...
    mes = _useState60[0],
    setMes = _useState60[1];
  var _useState61 = useState(new Date().getFullYear()),
    _useState62 = _slicedToArray(_useState61, 2),
    ano = _useState62[0],
    setAno = _useState62[1];
  ...
  var _useState65 = useState(null),
    ...
    detalhe = _useState66[0],
    setDetalhe = _useState66[1];
  var _useState67 = useState(null),
    _useState68 = _slicedToArray(_useState67, 2),
    excluirEvento = _useState68[0],
    setExcluirEvento = _useState68[1];
  var cor = config.corPrimaria || COR;
  if (loading) return /*#__PURE__*/React.createElement(Spinner, null);
  function navMes(dir) {
    var nm = mes + dir,
...
function ModalAviso(_ref13) {
  ...
  var cor = config.corPrimaria || COR;
  var _useState69 = useState(aviso ? {
      title: aviso.title,
  ...
  var _useState71 = useState(false),
    ...
    salvando = _useState72[0],
    setSalvando = _useState72[1];
  var _useState73 = useState(""),
    _useState74 = _slicedToArray(_useState73, 2),
    erro = _useState74[0],
    setErro = _useState74[1];
  function publicar() {
...
function Avisos(_ref14) {
  ...
  var _useState75 = useState(false),
    ...
    showModal = _useState76[0],
    setShowModal = _useState76[1];
  var _useState77 = useState(null),
    _useState78 = _slicedToArray(_useState77, 2),
    editAviso = _useState78[0],
    setEditAviso = _useState78[1];
  var cor = config.corPrimaria || COR;
...
// ── MÚSICAS ───────────────────────────────────────────────────────────────────
var CATEGORIAS_MUSICA = ["MPB", "Natal", "Regionais", "Sacro", "Clássico", "Popular", "Infantil", "Internacional", "Auris", "Autorais Cristãs", "Outro"];
var CAT_COLORS = {
  MPB: "#2E7D32",
  Natal: "#1565C0",
  Regionais: "#E65100",
...
function ModalMusica(_ref15) {
  ...
  var _useState79 = useState(musica ? _objectSpread(_objectSpread({}, vazio), musica) : vazio),
    _useState80 = _slicedToArray(_useState79, 2),
    form = _useState80[0],
    setForm = _useState80[1];
  var _useState81 = useState(false),
    _useState82 = _slicedToArray(_useState81, 2),
    salvando = _useState82[0],
    setSalvando = _useState82[1];
  var _useState83 = useState(""),
    _useState84 = _slicedToArray(_useState83, 2),
    erro = _useState84[0],
    setErro = _useState84[1];
  var _useState85 = useState(""),
    _useState86 = _slicedToArray(_useState85, 2),
    novaCategoria = _useState86[0],
    setNovaCategoria = _useState86[1];
  var _useState87 = useState(false),
    _useState88 = _slicedToArray(_useState87, 2),
    showNovaCateg = _useState88[0],
    setShowNovaCateg = _useState88[1];
  var _useState89 = useState(CATEGORIAS_MUSICA),
    _useState90 = _slicedToArray(_useState89, 2),
    categorias = _useState90[0],
    setCategorias = _useState90[1];
  function salvar() {
...
function Repertorio(_ref16) {
  ...
  var _useState91 = useState(""),
    ...
    busca = _useState92[0],
    setBusca = _useState92[1];
  var _useState93 = useState("Todas as Categorias"),
    _useState94 = _slicedToArray(_useState93, 2),
    filtro = _useState94[0],
    setFiltro = _useState94[1];
  var _useState95 = useState(null),
    _useState96 = _slicedToArray(_useState95, 2),
    modal = _useState96[0],
    setModal = _useState96[1];
  var _useState97 = useState(null),
    _useState98 = _slicedToArray(_useState97, 2),
    player = _useState98[0],
    setPlayer = _useState98[1];
  var cor = config.corPrimaria || COR;
  if (loading) return /*#__PURE__*/React.createElement(Spinner, null);
...
function ModalEstudo(_ref18) {
  ...
  var _useState99 = useState(estudo ? _objectSpread(_objectSpread({}, vazio), estudo) : vazio),
    _useState100 = _slicedToArray(_useState99, 2),
    form = _useState100[0],
    setForm = _useState100[1];
  var _useState101 = useState(false),
    _useState102 = _slicedToArray(_useState101, 2),
    salvando = _useState102[0],
    setSalvando = _useState102[1];
  var _useState103 = useState(""),
    _useState104 = _slicedToArray(_useState103, 2),
    erro = _useState104[0],
    setErro = _useState104[1];
  function salvar() {
...
function SalaEstudos(_ref19) {
  ...
  var _useState105 = useState("Todos"),
    ...
    filtro = _useState106[0],
    setFiltro = _useState106[1];
  var _useState107 = useState(null),
    _useState108 = _slicedToArray(_useState107, 2),
    modal = _useState108[0],
    setModal = _useState108[1];
  var _useState109 = useState(null),
    _useState110 = _slicedToArray(_useState109, 2),
    player = _useState110[0],
    setPlayer = _useState110[1];
  var cor = config.corPrimaria || COR;
  if (loading) return /*#__PURE__*/React.createElement(Spinner, null);
...
function Apresentacao(_ref21) {
  ...
  var _useState111 = useState(null),
    ...
    eventoSel = _useState112[0],
    setEventoSel = _useState112[1];
  var _useState113 = useState([]),
    _useState114 = _slicedToArray(_useState113, 2),
    setlist = _useState114[0],
    setSetlist = _useState114[1];
  var _useState115 = useState(null),
    _useState116 = _slicedToArray(_useState115, 2),
    tocando = _useState116[0],
    setTocando = _useState116[1];
  var _useState117 = useState(null),
    _useState118 = _slicedToArray(_useState117, 2),
    dragIdx = _useState118[0],
    setDragIdx = _useState118[1];
  var cor = config.corPrimaria || COR;
  var today = todayStr();
  useEffect(function () {
...
function Relatorios(_ref32) {
  ...
  var _useState121 = useState(new Date().getFullYear() + "-01-01"),
    ...
    dataInicio = _useState122[0],
    setDataInicio = _useState122[1];
  var _useState123 = useState(todayStr()),
    _useState124 = _slicedToArray(_useState123, 2),
    dataFim = _useState124[0],
    setDataFim = _useState124[1];
  var _useState125 = useState("todos"),
    _useState126 = _slicedToArray(_useState125, 2),
    eventoFiltro = _useState126[0],
    setEventoFiltro = _useState126[1];
  var _useState127 = useState({}),
    _useState128 = _slicedToArray(_useState127, 2),
    textos = _useState128[0],
    setTextos = _useState128[1];
  var _useState129 = useState(false),
    _useState130 = _slicedToArray(_useState129, 2),
    editTextos = _useState130[0],
    setEditTextos = _useState130[1];
  var _useState131 = useState({}),
    _useState132 = _slicedToArray(_useState131, 2),
    formTextos = _useState132[0],
    setFormTextos = _useState132[1];
  var _useState133 = useState(false),
    _useState134 = _slicedToArray(_useState133, 2),
    salvandoTextos = _useState134[0],
    setSalvandoTextos = _useState134[1];
...
function CheckinPublico(_ref41) {
  ...
  var _useState135 = useState(null),
    ...
    sessao = _useState136[0],
    setSessao = _useState136[1];
  var _useState137 = useState(null),
    _useState138 = _slicedToArray(_useState137, 2),
    membro = _useState138[0],
    setMembro = _useState138[1];
  ...
  var _useState141 = useState(""),
    ...
    busca = _useState142[0],
    setBusca = _useState142[1];
  var _useState143 = useState([]),
    _useState144 = _slicedToArray(_useState143, 2),
    sugestoes = _useState144[0],
    setSugestoes = _useState144[1];
  var _useState145 = useState(null),
    _useState146 = _slicedToArray(_useState145, 2),
    status = _useState146[0],
    setStatus = _useState146[1]; // null | 'ok' | 'erro' | 'expirado'
  var _useState147 = useState(true),
    _useState148 = _slicedToArray(_useState147, 2),
    loading = _useState148[0],
    setLoading = _useState148[1];
  var cor = config.corPrimaria || COR;
  useEffect(function () {
    // Carregar sessão
...
function Frequencia(_ref42) {
  ...
  var _useState149 = useState(""),
    ...
    eventoSel = _useState150[0],
    setEventoSel = _useState150[1];
  var _useState151 = useState(null),
    _useState152 = _slicedToArray(_useState151, 2),
    sessaoAtiva = _useState152[0],
    setSessaoAtiva = _useState152[1];
  var _useState153 = useState([]),
    _useState154 = _slicedToArray(_useState153, 2),
    frequencias = _useState154[0],
    setFrequencias = _useState154[1];
  var _useState155 = useState(""),
    _useState156 = _slicedToArray(_useState155, 2),
    qrUrl = _useState156[0],
    setQrUrl = _useState156[1];
  var _useState157 = useState(false),
    _useState158 = _slicedToArray(_useState157, 2),
    gerando = _useState158[0],
    setGerando = _useState158[1];
  var _useState159 = useState(false),
    _useState160 = _slicedToArray(_useState159, 2),
    showQR = _useState160[0],
    setShowQR = _useState160[1];
  var cor = config.corPrimaria || COR;
  var today = todayStr();
...
function Declaracao(_ref43) {
  ...
  var _useState161 = useState("evento"),
    ...
    tipo = _useState162[0],
    setTipo = _useState162[1]; // 'evento' | 'corista'
  var _useState163 = useState(""),
    _useState164 = _slicedToArray(_useState163, 2),
    eventoSel = _useState164[0],
    setEventoSel = _useState164[1];
  var _useState165 = useState(""),
    _useState166 = _slicedToArray(_useState165, 2),
    coristaId = _useState166[0],
    setCoristaId = _useState166[1];
  var _useState167 = useState(new Date().getFullYear() + "-01-01"),
    _useState168 = _slicedToArray(_useState167, 2),
    dataInicio = _useState168[0],
    setDataInicio = _useState168[1];
  var _useState169 = useState(todayStr()),
    _useState170 = _slicedToArray(_useState169, 2),
    dataFim = _useState170[0],
    setDataFim = _useState170[1];
  var _useState171 = useState({}),
    _useState172 = _slicedToArray(_useState171, 2),
    textos = _useState172[0],
...
function PainelCorista(_ref45) {
  ...
  var _useState173 = useState(new Date().getMonth()),
    ...
    mes = _useState174[0],
    setMes = _useState174[1];
  var _useState175 = useState(new Date().getFullYear()),
    _useState176 = _slicedToArray(_useState175, 2),
    ano = _useState176[0],
    setAno = _useState176[1];
  var _useState177 = useState({}),
    _useState178 = _slicedToArray(_useState177, 2),
    confirmacoes = _useState178[0],
    setConfirmacoes = _useState178[1];
  var _useState179 = useState(null),
    _useState180 = _slicedToArray(_useState179, 2),
    naipeOpen = _useState180[0],
    setNaipeOpen = _useState180[1];
  var _useState181 = useState(false),
    _useState182 = _slicedToArray(_useState181, 2),
    modalNoticiaCorista = _useState182[0],
    setModalNoticiaCorista = _useState182[1];
  var cor = config.corPrimaria || COR;
...
function MinhaDeclaracao(_ref46) {
  ...
  var _useState183 = useState(new Date().getFullYear() + "-01-01"),
    ...
    dataInicio = _useState184[0],
    setDataInicio = _useState184[1];
  var _useState185 = useState(todayStr()),
    _useState186 = _slicedToArray(_useState185, 2),
    dataFim = _useState186[0],
    setDataFim = _useState186[1];
  var _useState187 = useState({}),
    _useState188 = _slicedToArray(_useState187, 2),
    textos = _useState188[0],
...
function ModalNoticia(_ref47) {
  ...
  var _useState189 = useState(noticia ? _objectSpread(_objectSpread({}, vazio), noticia) : vazio),
    _useState190 = _slicedToArray(_useState189, 2),
    form = _useState190[0],
    setForm = _useState190[1];
  var _useState191 = useState(false),
    _useState192 = _slicedToArray(_useState191, 2),
    salvando = _useState192[0],
    setSalvando = _useState192[1];
  var _useState193 = useState(""),
    _useState194 = _slicedToArray(_useState193, 2),
    erro = _useState194[0],
    setErro = _useState194[1];
  function salvar() {
...
function AreaRH(_ref48) {
  ...
  var _useState195 = useState(abaInicial || "dashboard"),
    _useState196 = _slicedToArray(_useState195, 2),
    aba = _useState196[0],
    setAba = _useState196[1];
  useEffect(function () {
    if (abaInicial) setAba(abaInicial);
  }, [abaInicial]);
  var _useState197 = useState(null),
    _useState198 = _slicedToArray(_useState197, 2),
    modalNoticia = _useState198[0],
    setModalNoticia = _useState198[1];
  ...
  var _useState203 = useState(""),
    ...
    coristaDecl = _useState204[0],
    setCoristaDecl = _useState204[1];
  var _useState205 = useState(new Date().getFullYear() + "-01-01"),
    _useState206 = _slicedToArray(_useState205, 2),
    dataInicio = _useState206[0],
    setDataInicio = _useState206[1];
  var _useState207 = useState(todayStr()),
    _useState208 = _slicedToArray(_useState207, 2),
    dataFim = _useState208[0],
    setDataFim = _useState208[1];
  var coristaAtual = members.find(function (m) {
...
function ModalMensalidade(_ref55) {
  ...
  var _useState211 = useState({
    ...
    cfg = _useState212[0],
    setCfg = _useState212[1];
  var _useState213 = useState(false),
    _useState214 = _slicedToArray(_useState213, 2),
    salvando = _useState214[0],
    setSalvando = _useState214[1];
...
function ModalPagamento(_ref56) {
  ...
  var _useState217 = useState([]),
    ...
    meses = _useState218[0],
    setMeses = _useState218[1];
  ...
  function marcarPagoAdmin(_x1) {
    return _marcarPagoAdmin.apply(this, arguments);
  }
  function _marcarPagoAdmin() {
    _marcarPagoAdmin = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee28(mes) {
      var val;
      return _regenerator().w(function (_context28) {
        while (1) switch (_context28.n) {
          case 0:
            val = (mesalidade === null || mesalidade === void 0 ? void 0 : mesalidade.valorMensal) || 25;
            if (!mes.docId) {
              _context28.n = 2;
              break;
            }
  ...
  function marcarIsento(_x10) {
    return _marcarIsento.apply(this, arguments);
  }
  function _marcarIsento() {
    _marcarIsento = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee29(mes) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u2715")), m.status === "pendente" && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 6,
        flexWrap: "wrap"
    ...
    }, "Isentar")), m.status === "isento" && /*#__PURE__*/React.createElement("button", {
      onClick: function onClick() {
        return recusar(m);
      },
      disabled: salvando,
    ...
    }, "Remover isen\xE7\xE3o"), m.status === "pago" && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 11,
        color: "#2E7D32",
        fontWeight: 700
...
function ModalLancamento(_ref57) {
  ...
  var _useState221 = useState(lancamento ? _objectSpread(_objectSpread(_objectSpread({}, vazio), lancamento), {}, {
      valor: String(lancamento.valor || "")
    }) : vazio),
    _useState222 = _slicedToArray(_useState221, 2),
    form = _useState222[0],
    setForm = _useState222[1];
  ...
  var _useState225 = useState(""),
    ...
    erro = _useState226[0],
    setErro = _useState226[1];
  var _useState227 = useState(""),
    _useState228 = _slicedToArray(_useState227, 2),
    novaCat = _useState228[0],
    setNovaCat = _useState228[1];
  var _useState229 = useState(false),
    _useState230 = _slicedToArray(_useState229, 2),
    showNovaCat = _useState230[0],
    setShowNovaCat = _useState230[1];
  function salvar() {
...
function FinanceiroCorista(_ref62) {
  ...
  var _useState251 = useState(null),
    ...
    salvando = _useState252[0],
    setSalvando = _useState252[1];
...
function RifaBanner(_ref63) {
  ...
  var cor = config.corPrimaria || COR;
  var _useState257 = useState("https://luciakratz-arch.github.io/RIFA-ONIX/"),
    _useState258 = _slicedToArray(_useState257, 2),
    rifaUrl = _useState258[0],
    setRifaUrl = _useState258[1];
  var _useState259 = useState(false),
    _useState260 = _slicedToArray(_useState259, 2),
    editando = _useState260[0],
    setEditando = _useState260[1];
...
function Blog(_ref64) {
  ...
  var _useState263 = useState(null),
    ...
    modal = _useState264[0],
    setModal = _useState264[1];
  var cor = config.corPrimaria || COR;
...
function App() {
  ...
  var _useState269 = useState("painel"),
